# Run record: 20260912T235138Z_local_build_examples

- **Result**: FAIL
- **UTC timestamp**: 2026-09-12T23:51:38.471314+00:00
...
- `unlabelled_inferred_values`: [('R-A', 44, 'scenario', 'Historical --- a modeled baseline, not an observation'), ('R-A', 44, 'horizon', 'the modeled historical decade, 1995-2004'), ('R-A', 48, 'scenario', 'RCP8.5'), ('R-A', 48, 'horizon', 'End-Century, the modeled decade 2085-2094'), ('R-A', 52, 'scenario', 'Historical compared with RCP8.5'), ('R-A', 52, 'horizon', 'Historical (1995-2004) to End-Century (2085-2094)'), ('R-B', 44, 'scenario', 'Historical --- a modeled baseline, not an observation'), ('R-B', 44, 'horizon', 'the modeled historical decade, 1995-2004'), ('R-B', 48, 'scenario', 'RCP8.5'), ('R-B', 48, 'horizon', 'End-Century, the modeled decade 2085-2094'), ('R-B', 52, 'scenario', 'Historical compared with RCP8.5'), ('R-B', 52, 'horizon', 'Historical (1995-2004) to End-Century (2085-2094)'), ('R-C', 44, 'scenario', 'Historical --- a modeled baseline, not an observation'), ('R-C', 44, 'horizon', 'the modeled historical decade, 1995-2004'), ('R-C', 48, 'scenario', 'RCP8.5'), ('R-C', 48, 'horizon', 'End-Century, the modeled decade 2085-2094'), ('R-C', 52, 'scenario', 'Historical compared with RCP8.5'), ('R-C', 52, 'horizon', 'Historical (1995-2004) to End-Century (2085-2094)')]
