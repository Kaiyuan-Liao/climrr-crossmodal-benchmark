# Run record: 20260909T014344Z_local_dictionary_coverage

- **Result**: PASS
- **UTC timestamp**: 2026-09-09T01:43:44.556598+00:00
- **Git commit**: `b0599f1d70009232a9c241a61f523662e306532a`
- **Working tree dirty (tracked files)**: True
- **Untracked files present**: 15
...
- **Output path**: `dictionary_coverage.json`
...
```json
{
  ...
  "extracted_text_path": "dictionary_extracted.txt"
}
```
...
- `extracted_text_sha256`: 1b3075053ca2beef379e7d0be3cfd9162aba12b6af189017c81a313f4001073f
